module Cronofy
  ...
  class Client
    ...
    # event_id    - A String uniquely identifying the event for your application
    #               (note: this is NOT an ID generated by Cronofy).
    # status      - A String to set the participation status of the invite to
    #
    #
    # See http://www.cronofy.com/developers/api#delete-event for reference.
    #
    ...
    # Raises Cronofy::TooManyRequestsError if the request exceeds the rate
    # limits for the application.
    def change_participation_status(calendar_id, event_id, status)
      body = {
        status: status,
      }

      url = "/v1/calendars/#{calendar_id}/events/#{event_id}/participation_status"
      post(url, body)
    end
